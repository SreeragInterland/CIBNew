...
public class PermissionScreenConstants {
  ...
  public var subtitle = "May we access your device's microphone to enable record voice?"
...
public class NoPermissionScreenConstants {
  ...
  /// Subtitle shown at the top of the screen
  public var subtitle = "In order to record voice, you need to enable it in your setting's app."
...
public class InputScreenConstants {
  ...
  public var subtitleBullet = ""
  
  /// The list of query suggestions shown in a bullet list
  public var subtitleBulletList = [""]
...
public class ResultScreenConstants {
  ...
  public var titleProcessed: String = "" {
    didSet {
