                ...
                if drawXOutside || drawYOutside
                {
                    ...
                    if drawXOutside && drawYOutside
                    {
                        ChartUtils.drawText(
                            context: context,
                            text: "SAR \(valueText)",
                            point: CGPoint(x: labelPoint.x, y: labelPoint.y + lineHeight + 5),
                            align: align,
                            attributes: [NSAttributedString.Key.font: UIFont(name: "Roboto-Medium", size: 12), NSAttributedString.Key.foregroundColor: valueTextColor]
                        )
                        ...
                        if j < data.entryCount && pe?.label != nil
                        {
                            ChartUtils.drawText(
                                ...
                                align: align,
                                attributes: [
                                    NSAttributedString.Key.font: UIFont(name: "Roboto-Regular", size: 11)!,
        ...
        if chart.drawHoleEnabled
        {
            ...
            if let transparentCircleColor = chart.transparentCircleColor
            {
                    ...
                    chart.transparentCircleRadiusPercent > chart.holeRadiusPercent
                {
                    ...
                    context.setFillColor(UIColor(red: 0, green: 147/255, blue: 131/255, alpha: 1).cgColor)
